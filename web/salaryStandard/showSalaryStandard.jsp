<%@ page import="entity.SalaryStandard" %>
...
<s:form action="updateSalaryStandard.action" method="POST" namespace="/salaryStandard" theme="simple">
    <s:hidden name="salaryStandard.id" />
